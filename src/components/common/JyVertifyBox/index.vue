      ...
      <div class="vertify">
        ...
        <div class="content">
          ...
          >
            ...
            >
              <div
                ...
                :style="{
                  width:
                    sliderLeft > 0 ? sliderLeft + 8 + 'px' : sliderLeft + 'px'
                }"
              >
                <!-- <div
                  className="slider"
                ...
                <svg
                  class="iconpark-icon slider"
                  :style="{ left: sliderLeft - 10 + 'px' }"
                  @mousedown="handleDragStart"
                  @touchstart="handleDragStart"
                >
                  <use href="#btn1" class="btn1"></use>
                  <use href="#btn2" class="btn2"></use>
                </svg>
              </div>
          ...
          <div class="vertify-footer">
            ...
            <svg class="iconpark-icon" @click="handleRefresh">
              <use href="#flush"></use>
            </svg>
          </div>
        </div>
