    ...
    <div class="verification-details">
        <div class="verification-wrap" v-for="(it, id) in data">
            <div class="verification-title" v-if="it.length > 0">
                <div class="verification-title-item verification-title-item-success" v-if="id === 'successResult'">
                    <span></span>核验通过</div>
                <div class="verification-title-item verification-title-item-error" v-if="id === 'errorResult'"><span
