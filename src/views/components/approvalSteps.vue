      ...
      <div class="ap-box-list" v-for="(item, index) in props.data" :key="index">
        ...
        <div class="ap-box-list-cont">
          <div class="ap-box-list-cont-title">
            ...
            <span
              class="ap-box-list-cont-title-subText"
          ...
          <div class="ap-box-list-cont-person">
            <div
              class="ap-box-list-cont-person-box flowing"
              v-if="item.type == 'flowing'"
            >
              <div
                class="flowing-cont"
                v-for="(data, num) in item.personList"
                :key="num"
              >
                ...
                <div
                  class="flowing-cont-image"
                  v-if="num < item.personList.length - 1"
                >
            ...
            <div class="ap-box-list-cont-person-box after" v-else>
              <div class="after-cont">
                <div
                  class="after-cont-list person-cell"
                  v-for="data in item.personList"
                >
                  <div class="person-cell-jian">
                    <span class="person-cell-jian-name">
                      {{ data.name.slice(-2) }}</span
                    >
                  </div>
                  <div class="person-cell-name">
                    {{ data.name }}
