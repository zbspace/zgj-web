    ...
    <div class="vertify-box">
      <div className="vertifyWrap" :style="{
        ...
        <div :className="sliderClass" :style="{
          ...
          <div className="sliderMask" :style="{ width: sliderLeft > 0 ? sliderLeft + 8 + 'px' : sliderLeft + 'px' }">
        ...
        <div className="refreshIcon" v-if="false" @click="handleRefresh" :style="{ backgroundImage: `url(${refreshIcon})` }"></div>
      ...
      <div class="vertify-footer">
        <img class="image" src="../../assets/images/login/close_circle_line.svg" />
        <img @click="handleRefresh" src="../../assets/images/login/refresh_line.svg" :class="isLoading ? 'loading-icon' : ''" />
      </div>
    </div>
