...
<template>
    <div class="Seal-application-fill-form">
        <componentsLayout Layout="breadcrumb,title,custom">
            <template #breadcrumb>
                <div class="breadcrumb">
                    <el-breadcrumb separator="/">
                        ...
                        <el-breadcrumb-item>实被取出印章列表</el-breadcrumb-item>
                    </el-breadcrumb>
                </div>
            </template>
            <template #title>
            ...
            <template #custom>
                <div class="custom">
                    <componentsTable :defaultAttribute="state.outSealList.defaultAttribute"
                        :data="state.outSealList.data"
                        :header="state.outSealList.header" @cellClick="cellClick"
