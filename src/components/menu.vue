  ...
  <div class="container-fluid components-menu">
    ...
    <template v-else>
      <ul class="navbar-nav h-100" id="navbar-nav">
        <li
          class="nav-item"
          v-show="sidebarSize === 'sm' || sidebarSize === 'sm-hover'"
        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <path
                d="M12.4367 4.13379L15 6.42502L12.4367 8.68482"
                stroke="black"
                stroke-opacity="0.45"
                stroke-width="1.5"
                stroke-linecap="round"
              ...
              <router-link class="nav-link menu-link" :to="item.to">
                ...
                >
                  ...
                  >
                    ...
                    />
                    <path
                      d="M3.5633 4.13379L1 6.42502L3.5633 8.68482"
                      stroke="black"
                      stroke-opacity="0.45"
                      stroke-width="1.5"
                      stroke-linecap="round"
