...
<template>
  <div class="documentsDetails-digital-seal">
    <div
      class="ap-box printed"
      v-if="props.signatoryFileData && props.signatoryFileData.length > 0"
    >
      <div class="ap-box-title">签署方信息</div>
      <div class="ap-box-table">
        <componentsTable
          :data="state.cache.signatoryData.data"
          :header="state.cache.signatoryData.header"
    ...
    >
      ...
      <div
        class="ap-box-cont"
        v-for="(item, index) in props.signatoryFileData"
        :key="index"
      >
    ...
    <div
      class="ap-box additional"
      v-if="
        props.alreadySignatoryFileData &&
        props.alreadySignatoryFileData.length > 0
      "
    >
      <div class="ap-box-title">已签署文件</div>
      <div
        class="ap-box-cont"
        v-for="(item, index) in props.alreadySignatoryFileData"
        :key="index"
      >
        <div class="ap-box-cont-desc">
          <span class="ap-box-cont-desc-name">{{ item.name }}</span>
