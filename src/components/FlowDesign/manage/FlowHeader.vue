<template>
  <a-row class="flow-header" :style="headerStyle" :bordered="false">
    ...
    <a-col :span="16">
      ...
      <a-menu v-if="isMenu" :selectedKeys="selectedKeys" mode="horizontal" :style="menuStyle" @select="handleSelect">
      ...
      <div class="publish">
        <a-space>
          <slot name="button">
            ...
            <a-button v-if="props.update && flowStore.isUpgrade" size="mini" type="primary" @click="upgrade">
              <i class="el-icon-s-promotion"></i>
              <span>升版</span>
            </a-button>
            <a-button v-if="!props.update" size="mini" type="primary" @click="save">
              <i class="el-icon-s-promotion"></i>
...
const emit = defineEmits(['update:modelValue', 'to', 'refresh', 'upgrade', 'save', 'back','export','import']);
