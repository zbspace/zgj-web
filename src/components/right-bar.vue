                    ...
                    <div class="form-check sidebar-setting card-radio">
                      ...
                      <label class="form-check-label p-0 avatar-md w-100" for="preloader-view-none">
                        <span class="d-flex gap-1 h-100">
                          <span class="flex-shrink-0">
                            <span class="bg-light d-flex h-100 flex-column gap-1 p-1">
                              <span class="d-block p-1 px-2 bg-primary rounded mb-2" />
                              <span class="d-block p-1 px-2 pb-0 bg-soft-primary" />
                              <span class="d-block p-1 px-2 pb-0 bg-soft-primary" />
                              <span class="d-block p-1 px-2 pb-0 bg-soft-primary" />
                            </span>
...
export default {
  ...
  mounted() {
    const rightbar_isopen = localStorage.getItem('rightbar_isopen')
  ...
  computed: {
    ...
    position: {
      ...
      set(position) {
        ...
        //   position: position,
        // });
        layoutStore.changePosition(position)
      }
    },
    sidebarView: {
      get() {
      ...
      set(sidebarView) {
        ...
        // });
        layoutStore.changeSidebarView(sidebarView)
      }
    },
    sidebarColor: {
      get() {
      ...
      set(sidebarColor) {
        ...
        // });
        layoutStore.changeSidebarColor(sidebarColor)
      }
    },
    sidebarImage: {
      get() {
      ...
      set(sidebarImage) {
        ...
        // });
        layoutStore.changeSidebarImage(sidebarImage)
      }
    },
    preloader: {
      get() {
        // return this.$store ? this.$store.state.layout.preloader : {} || {};
        return layoutStore.preloader
      },
      set(preloader) {
        // return this.changePreloader({
        //   preloader: preloader,
        // });
        layoutStore.changePreloader(preloader)
      }
    },
    mode: {
      get() {
