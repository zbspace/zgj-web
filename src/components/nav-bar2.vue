      ...
      <div class="navbar-header">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="ap-personalCenter">
            ...
            <div class="ap-personalCenter-text" @click="openUserInfo">
              <span class="ap-personalCenter-name">春青</span>
              <span class="ap-personalCenter-icon">
                <i class="ri-arrow-down-s-fill" v-show="showUserInfo"></i>
                <i class="ri-arrow-up-s-fill" v-show="!showUserInfo"></i>
              </span>
            </div>
            <div class="dropdown-menu" :class="showUserInfo ? 'show' : ''" style="width: 240px; right: 10px;">
