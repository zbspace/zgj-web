                ...
                <div class="card-body">
                  <div class="d-flex mb-2">
                    <h6 class="fs-15 mb-0 flex-grow-1 text-truncate">
                      <router-link to="/apps/tasks-details" class="text-body">{{
                        data.title
                      }}</router-link>
                    </h6>
                    <div class="dropdown">
            ...
            <draggable :list="todo" class="dragArea" group="todo">
              ...
              >
                <div class="card-body">
                  <div class="d-flex mb-2">
                    <h6 class="fs-15 mb-0 flex-grow-1 text-truncate">
                      <router-link to="/apps/tasks-details" class="link-secondary">{{
                        data.title
                      }}</router-link>
                    </h6>
                    <div class="dropdown">
      ...
      <div class="tasks-list">
        <div class="d-flex mb-3">
          <div class="flex-grow-1">
            <h6 class="fs-14 text-uppercase fw-semibold mb-0">
              In Reviews
              <small class="badge bg-success align-bottom ms-1">3</small>
            </h6>
          </div>
          <div class="flex-shrink-0">
            <div class="dropdown card-header-dropdown">
