                    ...
                    <div class="col-xxl-4 col-lg-6">
                        <div class="card card-body">
                            <div class="avatar-sm mb-3">
                                <div
                                    class="avatar-title bg-light text-primary fs-17 rounded"
                                >
                    ...
                    <div class="col-xxl-4 col-lg-6">
                        <div class="card card-body text-center">
                            <div class="avatar-sm mx-auto mb-3">
                                <div
                                    class="avatar-title bg-ligth text-primary fs-17 rounded"
                                >
                ...
                <div class="row">
                    <div class="col-xxl-4 col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <a href="javascript:void(0);" class="link-primary float-end">
                                    Read More
                                    <i
