              ...
              <table class="table mb-0">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="badge badge-soft-success">Inprogress</span>
                    </td>
                  </tr>
                  <tr>
              ...
              <li>
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1 ms-2">
                    <h6 class="mb-1">
                      <router-link to="/pages/profile" class="link-secondary"
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3 flex-grow-1">
                              <h6 class="fs-15 mb-0">
                                <a href="javascript:void(0)" class="link-secondary">App pages.zip</a>
                              </h6>
                            </div>
                          </div>
                        </td>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3 flex-grow-1">
                              <h6 class="fs-15 mb-0">
                                <a href="javascript:void(0);" class="link-secondary">Images.zip</a>
                              </h6>
                            </div>
                          </div>
                        </td>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3 flex-grow-1">
                              <h6 class="fs-15 mb-0">
                                <a href="javascript:void(0);" class="link-secondary">Bg-pattern.png</a>
                              </h6>
                            </div>
                          </div>
                        </td>
