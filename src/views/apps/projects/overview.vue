                    ...
                    <div class="col-md">
                      <div>
                        ...
                        <div class="hstack gap-3 flex-wrap">
                          ...
                          <div>
                            Due Date :
                            <span class="fw-medium">29 Dec, 2021</span>
                          </div>
                          <div class="vr"></div>
                          <div class="badge rounded-pill bg-primary fs-12">
                            New
                          </div>
      ...
      <div class="col-lg-12">
        <div class="tab-content text-muted">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-3 col-sm-6">
                            <div>
                              ...
                              <div class="badge bg-success fs-11">High</div>
                            </div>
                          </div>
                          <div class="col-lg-3 col-sm-6">
                            <div>
                              ...
                              <div class="badge bg-primary fs-11">
                                Inprogess
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="row g-3">
                        ...
                        <div class="col-12 text-end">
                          <button
                            type="button"
                            class="
                              btn btn-ghost-primary btn-icon
                              waves-effect
                              me-1
                            "
                          >
                ...
                <div class="card">
                  ...
                  >
                    ...
                    <div class="flex-shrink-0">
                      ...
                      >
                        <i class="ri-share-line me-1 align-bottom"></i> Invite
                        Member
                      </button>
                    </div>
                  </div>
          ...
          <div class="tab-pane fade" id="project-team" role="tabpanel">
            ...
            <div
              class="row g-0 text-center text-sm-start align-items-center mb-3"
            >
              <div class="col-sm-6">
                <div>
