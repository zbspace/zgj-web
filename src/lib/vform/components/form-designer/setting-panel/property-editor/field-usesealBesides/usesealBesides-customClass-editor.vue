<template>
  <div>
		<el-form-item label="地址标题">
			<el-input v-model="optionModel.addTitle"></el-input>
		</el-form-item>
...
<script>
  import i18n from "@/lib/vform/utils/i18n"
	import {deepClone, generateId, getDSByName} from "@/lib/vform/utils/util"
	import Sortable from "sortablejs"
	import CodeEditor from '@/lib/vform/components/code-editor'

  export default {
    name: "usesealBesides-customClass-editor",
