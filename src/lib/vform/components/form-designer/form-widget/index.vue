...
<script>
  import '@/lib/vform/components/form-designer/form-widget/container-widget/index'
  ...
  import { getCustomerType } from '@/lib/vform/utils/util'
  export default {
    name: 'VFormWidget',
    ...
    created() {
      ...
      if (getCustomerType() === 'PHONE') {
        this.designer.formConfig.cssCode = this.designer.formConfig.phoneCssCode
      } else if (getCustomerType() === 'PAD') {
        this.designer.formConfig.cssCode = this.designer.formConfig.padCssCode
      }
    },
    mounted() {
