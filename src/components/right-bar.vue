  ...
  <div>
    ...
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
      <div class="d-flex align-items-center bg-primary bg-gradient p-3 offcanvas-header">
        <h5 class="m-0 me-2 text-white">主题定制器</h5>
      ...
      <div class="offcanvas-body p-0">
        <SimpleBar class="h-100">
          <div class="p-4">
            <h6 class="mb-0 fw-semibold text-uppercase">布局</h6>
            <p class="text-muted">选择您的布局</p>
            ...
            <div class="row">
              <div class="col-4">
                ...
                <h5 class="fs-13 text-center mt-2">垂直</h5>
              </div>
              <div class="col-4">
                <div class="form-check card-radio">
                ...
                <h5 class="fs-13 text-center mt-2">水平</h5>
              </div>
              <div class="col-4">
                <div class="form-check card-radio">
                ...
                <h5 class="fs-13 text-center mt-2">两列</h5>
              </div>
              <!-- end col -->
            </div>

            <h6 class="mt-4 mb-0 fw-semibold text-uppercase">配色方案</h6>
            <p class="text-muted">选择浅色或深色方案</p>
            ...
            <div v-if="layoutType != 'twocolumn'" id="layout-width">
              <h6 class="mt-4 mb-0 fw-semibold text-uppercase">布局宽度</h6>
              <p class="text-muted">选择流体或者盒式布局</p>
              ...
              <div class="row">
                <div class="col-4">
                  ...
                  <h5 class="fs-13 text-center mt-2">流体</h5>
                </div>
                <div class="col-4">
                  <div class="form-check card-radio">
                    <input class="form-check-input" type="radio" v-model="layoutWidth" name="data-layout-width"
                  ...
                  <h5 class="fs-13 text-center mt-2">盒式</h5>
                </div>
              </div>
            </div>
            ...
            <div v-if="layoutType != 'twocolumn'" id="layout-position">
              ...
              <div class="btn-group radio" role="group">
                ...
                <label class="btn btn-light w-sm" for="layout-position-fixed">固定</label>
                ...
                <label class="btn btn-light w-sm ms-0" for="layout-position-scrollable">可滚动</label>
              </div>
            </div>
            <h6 class="mt-4 mb-0 fw-semibold text-uppercase">顶栏颜色</h6>
            <p class="text-muted">选择浅色或深色顶栏颜色</p>
            ...
            <div v-if="layoutType == 'vertical'" id="sidebar-size">
              <h6 class="mt-4 mb-0 fw-semibold text-uppercase">侧边栏大小</h6>
              <p class="text-muted">选择侧边栏的大小</p>
              ...
              <div class="row">
                ...
                <div class="col-4">
                  ...
                  <h5 class="fs-13 text-center mt-2">小 (图标视图)</h5>
                </div>
                ...
                <div class="col-4">
                  ...
                  <h5 class="fs-13 text-center mt-2">小型悬停视图</h5>
                </div>
              </div>
            </div>

            <div v-if="layoutType == 'vertical'" id="sidebar-view">
              <h6 class="mt-4 mb-0 fw-semibold text-uppercase">侧边栏视图</h6>
              <p class="text-muted">选择默认或分离的侧边栏视图</p>
              ...
              <div class="row">
                ...
                <div class="col-4">
                  ...
                  <h5 class="fs-13 text-center mt-2">分离的</h5>
                </div>
              </div>
            </div>
            <div v-if="layoutType != 'horizontal'" id="sidebar-color">
              ...
              <div class="row">
                ...
                <div class="col-4">
                  ...
                  <h5 class="fs-13 text-center mt-2">渐变</h5>
                </div>
              </div>
            ...
            <div v-if="layoutType != 'horizontal'" id="sidebar-img">
              <h6 class="mt-4 mb-0 fw-semibold text-uppercase">侧边栏图像</h6>
              <p class="text-muted">选择侧边栏的背景图片</p>
            ...
            <div id="preloader-menu">
              <h6 class="mt-4 mb-0 fw-semibold text-uppercase">预加载器</h6>
              <p class="text-muted">是否使用预加载器</p>
              ...
              <div class="row">
                <div class="col-4">
                  ...
                  <h5 class="fs-13 text-center mt-2">使用</h5>
                </div>
                <div class="col-4">
                  <div class="form-check sidebar-setting card-radio">
                    <input class="form-check-input" v-model="preloader" type="radio" name="data-preloader"
                  ...
                  <h5 class="fs-13 text-center mt-2">不使用</h5>
                </div>
              </div>
      ...
      <div class="offcanvas-footer border-top p-3 text-center">
        <div class="row">
          ...
          <div class="col-6">
            <button type="button" class="btn btn-primary w-100">立即购买</button>
          </div>
        </div>
      </div>
    </div>
