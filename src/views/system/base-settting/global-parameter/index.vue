<template>
  <div class="components-Layout">
    ...
    <div style="padding-left: 20px;">
      <VTabs :active="currentValue" :label="tabsLabel" @update:active="currentValue = $event" :border="false"></VTabs>
    </div>
    <keep-alive>
...
const tabsLabel = ref([
  ...
  {
    name: 't-smart-terminal-setting',
    value: '3'
  },
  {
    name: 't-zgj-F_SYS_UNIT_EXPORT_TEMPLATE_SETTING',
    value: '4'
  },
])
const map = {
