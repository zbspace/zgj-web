            ...
            <template #breadcrumb>
                <div class="breadcrumb">
                    <el-breadcrumb separator="/">
                        <el-breadcrumb-item>{{ state.checkStep.useStep }} </el-breadcrumb-item>
                        <el-breadcrumb-item>{{ state.checkStep.ocrStep }}</el-breadcrumb-item>
            ...
            <template #custom>
                <div class="custom">
                    <div v-for="(item, index) in state.checkList.filesFront">
                        <div class="files-name"><img src="../../../../assets/svg/file-icon.svg" />{{ item.fileName }}
                        </div>
                        <componentsTable :defaultAttribute="state.checkList.defaultAttribute" :data="item.records"
                            :header="state.checkList.header" @cellClick="cellClick" @custom-click="customClick"
...
if (urlParams.indexOf('post') == -1) {//用印前文件核验
