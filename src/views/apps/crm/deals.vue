...
<template>
 ...
 <Multiselect class="form-control"
    ...
    <div class="row row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
                ...
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed"  id="leadDiscovered1">
                        ...
                        <div class="card-footer hstack gap-2">
                            ...
                            <button class="btn btn-primary btn-sm w-100"><i class="ri-question-answer-line align-bottom me-1"></i> Message</button>
                        </div>
                    </div>
                </div><!--end card-->
                <div class="card mb-1">
        ...
        <div class="col">
            <div class="card">
                <a class="card-header bg-soft-primary" data-bs-toggle="collapse" href="#contactInitiated" role="button" aria-expanded="false" aria-controls="contactInitiated">
            ...
            <div class="collapse show"  id="needsIdentified">
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="collapse border-top border-top-dashed"  id="needsIdentified4">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Themesbrand <small class="badge badge-soft-primary">3 Month</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                                <li>
                                    <div class="d-flex">
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="collapse border-top border-top-dashed"  id="needsIdentified5">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Themesbrand <small class="badge badge-soft-primary">3 Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                                <li>
                                    <div class="d-flex">
        ...
        <div class="col">
            <div class="card">
                <a class="card-header bg-soft-primary" data-bs-toggle="collapse" href="#meetingArranged" role="button" aria-expanded="false" aria-controls="meetingArranged">
            ...
            <div class="collapse show"  id="offerAccepted">
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="collapse border-top border-top-dashed"  id="offerAccepted6">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Nesta Technologies <small class="badge badge-soft-primary">14 Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                                <li>
                                    <div class="d-flex">
