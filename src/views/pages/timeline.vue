                  ...
                  <div class="flex-grow-1 ms-3">
                    ...
                    <div class="hstack gap-2">
                      <a class="btn btn-sm btn-light"
                        ><span class="me-1">&#128293;</span> 19</a
                      >
                      <a class="btn btn-sm btn-light"
                        ><span class="me-1">&#129321;</span> 22</a
                      >
                    </div>
                  </div>
                </div>
            ...
            <div class="timeline-item left">
              ...
              <div class="content shadow-none">
                ...
                <p class="text-muted">
                  ...
                  information with your team to understand and contribute to
                  your project.
                </p>
            ...
            <div class="timeline-item right">
              ...
              <div class="content shadow-none">
                ...
                <p class="text-muted fst-italic mb-2">
                  ...
                  well structured and uses state of the art components (e.g. one
                  of the only templates using boostrap 5.1.3 so far). I
                  integrated it into a Rails 6 project. Needs manual integration
                  work of course but the template structure made it easy. "
                </p>
                <div class="hstack gap-2">
                  <a class="btn btn-sm bg-light"
                    ><span class="me-1">&#128151;</span> 35</a
                  >
                  <a class="btn btn-sm btn-light"
                    ><span class="me-1">&#128077;</span> 10</a
                  >
                  <a class="btn btn-sm btn-light"
                    ><span class="me-1">&#128591;</span> 10</a
                  >
            ...
            <div class="timeline-item right">
              ...
              <div class="content shadow-none">
                ...
                <p class="text-muted mb-2">
                  ...
                  when a ticket is created as our IT staff are mobile and will
                  not always be looking at the dashboard for new tickets.
                </p>
                <a
                  href="javascript:void(0);"
                ...
                <div class="col-12">
                  <div class="timeline-box">
                    <div class="timeline-text">
                      <h5>Trip planning</h5>
                      <p class="text-muted">
                        In the trip planner, keep only one or two activities in
                        a day if the purpose of the trip is to relax and take it
                  ...
                  <div class="timeline-box">
                    <div class="timeline-text">
                      ...
                      <p class="text-muted mb-0">
                        ...
                        describe the significance of your findings in light of
