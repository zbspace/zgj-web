    ...
    <div class="selection-content">
      ...
      <div class="selection-right user-select">
        <div class="select-right-column c-p">
          <div class="clear-n"> 已选： {{ allSelected.length }}个文件类型</div>
...
<script setup>
  ...
  import { ref } from 'vue'
  import KDocumentType from './modules/KDocumentType.vue'
  ...
  // 清空选中项
  const clearSelected = () => {
    documentRef.value.clearSelected()
  }

  // 取消选中项
  const concelSelected = attr => {
    documentRef.value.concelSelected(attr)
  }
