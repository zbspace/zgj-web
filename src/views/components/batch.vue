    ...
    <div class="ap-box">
      ...
      <div class="ap-box-right">
        <img
          ...
          src="@/assets/svg/biaoge-piliang-shaxin.svg"
          alt=""
        />
        <img
          class="ap-box-right-icon"
          src="@/assets/svg/biaoge-piliang-daochu.svg"
          alt=""
        />
        <img
          class="ap-box-right-icon"
          src="@/assets/svg/biaoge-piliang-dayin.svg"
          alt=""
        />
        <img
          class="ap-box-right-icon"
          src="@/assets/svg/biaoge-piliang-quanping.svg"
          alt=""
        />
        <img
          class="ap-box-right-icon margin-0"
          src="@/assets/svg/biaoge-piliang-shezhi.svg"
          alt=""
        />
      </div>
    </div>
