<template>
  <div class="flow-row-container">
    ...
    />
    <FlowFreeNode
      v-if="node && node.nodeType == 30"
      :node="node"
      :readable="readable"
      @nodeUpdate="nodeUpdate"
    />
    <FlowCopyerNode
      v-if="node && node.nodeType == 2"
      :node="node"
      :readable="readable"
      @nodeUpdate="nodeUpdate"
    />
    <FlowBranchNode
      v-if="node && node.nodeType == 4"
      :node="node"
      :readable="readable"
      @nodeUpdate="nodeUpdate"
    />
    <FlowSuggestNode
      v-if="node && node.nodeType == 7"
      :node="node"
      :readable="readable"
      @nodeUpdate="nodeUpdate"
    />
    <FlowParallelNode
      v-if="node && node.nodeType == 9"
      :node="node"
      :readable="readable"
      @nodeUpdate="nodeUpdate"
    />
    <FlowPolymerizeNode
      v-if="node && node.nodeType == 11"
      :node="node"
      :readable="readable"
      @nodeUpdate="nodeUpdate"
    />
    <FlowNoticeNode
      v-if="node && node.nodeType == 20"
      :node="node"
      :readable="readable"
      @nodeUpdate="nodeUpdate"
    />
    <FlowEventNode
      v-if="node && node.nodeType == 5"
      :node="node"
      :readable="readable"
      @nodeUpdate="nodeUpdate"
    />
