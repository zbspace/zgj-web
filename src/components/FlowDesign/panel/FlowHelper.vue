<template>
  <div class="flow-helper" id="flow-helper">
    <div
      id="flow-helper-setting"
      class="flow-helper-setting"
      @click="flowConfigDrawer.show()"
    >
      <span class="flow-helper-title">流程配置</span>
      <right-outlined class="flow-helper-right-icon" />
    </div>
    <div
      id="flow-helper-adjuvant"
      class="flow-helper-adjuvant"
      @click="flowAdjuvantDrawer.show()"
    >
    ...
    <div
      id="flow-helper-strengthen"
      class="flow-helper-strengthen"
      @click="flowStrengthenDrawer.show()"
    >
    ...
    <div
      id="flow-helper-guide"
      class="flow-helper-guide"
      @click="flowGuideDrawer.show()"
    >
