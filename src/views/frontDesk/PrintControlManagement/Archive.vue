...
<template>
  <div class="PrintControlManagement-Archive">
      ...
      <template #title>
        <div class="title">
          ...
          <div class="title-more">
            ...
            <div class="title-more-down" v-if="state.componentsTitle.more.data.length > 0">
              <el-dropdown>
                <el-button>
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    <el-dropdown-item v-for="(item, index) in state.componentsTitle.more.data" :key="index">
                      {{ item.name }}
                    </el-dropdown-item>
                  </el-dropdown-menu>
                </template>
      ...
      <template #searchForm>
        <div>
          <componentsSearchForm :data="state.componentsSearchForm.data" :butData="state.componentsSearchForm.butData"
            :style="state.componentsSearchForm.style" @clickElement="clickElement">
      ...
      <template #table>
        <div>
          <componentsTable :defaultAttribute="state.componentsTable.defaultAttribute" :data="state.componentsTable.data"
            :header="state.componentsTable.header" @cellClick="cellClick" @custom-click="customClick"
    ...
    <!-- 文件归档弹窗 -->
    <KDialog @update:show="dialogData.show = $event" :show="dialogData.show" title="文件归档" :oneBtn="false"
      :confirmText="$t('t-zgj-operation.submit')" :concelText="$t('t-zgj-operation.cancel')">
          ...
          <div class="from-wrap">
            <el-form :inline="true" label-width="70px" label-position="left">
              <el-form-item label="单据编号">
                <el-input v-model="state.componentsArchiveForm.applyCode" disabled type="text" />
              </el-form-item>
              <el-form-item label="单据名称">
                <el-input v-model="state.componentsArchiveForm.applyName" disabled />
              </el-form-item>
            </el-form>
            <el-form :inline="true" label-width="70px" label-position="left">
              <el-form-item label="归档时间">
                <el-date-picker v-model="state.componentsArchiveForm.time" type="datetime" placeholder="请选择时间" />
              </el-form-item>
              <el-form-item label="档案字号">
                <el-input v-model="state.componentsArchiveForm.fileCode" placeholder="请输入" />
              </el-form-item>
            </el-form>
            <el-form label-width="70px" label-position="left">
              <el-form-item label="归档备注">
                <el-input v-model="state.componentsArchiveForm.remark" type="textarea" placeholder="请输入" />
              </el-form-item>
            </el-form>
          </div>
        </template>
      ...
      <documentsDetailsPortion>
        ...
        <template #content>
          <div class="files-wrap content-wrap" v-if="state.componentsArchiveForm.files.length > 0">
            <span>文件归档</span>
            <div class="files-list">
              <div class="files-item" v-for="(item, index) in state.componentsArchiveForm.files" :key="index">
                ...
                <div class="add-file" v-if="item.type < 2">
                  <el-upload ref="upload" class="upload-demo"
                    ...
                    <template #trigger>
                      <svg preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" width="1em"
                        height="1em" fill="" viewBox="0 0 16 16">
                        <g>
                          <g fill-rule="nonzero" fill="#1985F5" data-follow-fill="#1985F5">
                ...
                <div class="view-file" v-if="item.type == 2">
                  <div class="upload-file">
                    <div v-if="item.isArchived">
                      <img src="../../../assets/svg/upload/icon-pdf.svg" />{{ item.archiveAttachmentFileName }}（{{
                        item.fileSize
                      }}）
                    </div>
                    <div v-else>
                      <svg class="iconpark-icon">
                        <use href="#folder"></use>
                      </svg>{{ item.archiveAttachmentFileName }}
                    </div>
                  </div>
          ...
          <div class="files-add content-wrap">
            ...
            <div class="upload-archives-element">
              <el-upload ref="upload" class="upload-demo"
                action="https://run.mocky.io/v3/9d059bf9-4660-45f2-925d-ce80ad6c4d15" multiple :on-exceed="handleExceed"
                :auto-upload="false" :show-file-list="false" :on-change="uploadFiles">
                <template #trigger>
                  <svg class="iconpark-icon">
              ...
              <div class="upload-files-list">
                <div class="upload-file-item" v-for="(item, index) in state.componentsArchiveForm.supplemenFiles">
  ...
  componentsArchiveForm: {
    ...
    files: [
      ...
      },
      {
        ...
        fileSize: '500K',
        type: 2,
        archiveAttachmentFileName: 'ff808081842bd69201842be2dad701241675818532806.jpg',
        isArchived: false,
      },
      {
        fileName: '电子盖章问题.doc',
