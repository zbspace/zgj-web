    ...
    >
      <template v-for="item in state1.menu">
          ...
          <div v-for="child in item.children" :key="child.label">
            ...
            >
              ...
              <div v-for="child1 in child.children" :key="child1.label">
                ...
                >
                  <span class="name-front"></span>
                  <span class="normal-color">{{ child1.name }}</span>
                </el-menu-item>
                <p v-else>
                  {{ child1.name }}
                </p>
            ...
            >
              <span class="name-front"></span>
              <span class="normal-color"> {{ child.name }}</span>
            </el-menu-item>
            <p v-else>
              {{ child.name }}
            </p>
        ...
        >
          ...
          <template v-if="item.to === '/frontDesk/home'">
            <svg
              class="iconpark-icon contraction-icon"
              @click="layoutStore.changeCollapse(!layoutStore.isCollapse)"
            >
...
<script setup>
  ...
  if (CurrentSystemType === 'business') {
    state1.value.menu = business
  } else if (CurrentSystemType === 'system') {
    state1.value.menu = system
  }
  onMounted(() => {
