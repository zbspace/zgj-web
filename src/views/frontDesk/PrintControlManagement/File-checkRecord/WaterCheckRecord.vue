            ...
            <template #custom>
                <div class="custom">
                    <documentsDetailsPortion>
                        <template #title>
                            <div class="ap-cont-box-title-label">盖前水印验证</div>
                        </template>
                        <template #content>
                            <div v-for="(item, index) in state.checkList.filesFront">
                                <div class="files-name"><img src="../../../../assets/svg/file-icon.svg"/>{{ item.fileName }}</div>
                                <componentsTable :defaultAttribute="state.checkList.defaultAttribute"
                                    :data="item.records" :header="state.checkList.header"
                    ...
                    <documentsDetailsPortion>
                        <template #title>
                            <div class="ap-cont-box-title-label">盖中水印验证</div>
                        </template>
                        <template #content>
                            <div v-for="(item, index) in state.checkList.filesMiddle">
                                <div class="files-name"><img src="../../../../assets/svg/file-icon.svg"/>{{ item.fileName }}</div>
                                <componentsTable :defaultAttribute="state.checkList.defaultAttribute"
                                    :data="item.records" :header="state.checkList.header"
                                    @cellClick="cellClick" @custom-click="customClick"
                    ...
                    <documentsDetailsPortion>
                        <template #title>
                            <div class="ap-cont-box-title-label">盖后水印验证</div>
                        </template>
                        <template #content>
                            <div v-for="(item, index) in state.checkList.filesRear">
                                <div class="files-name"><img src="../../../../assets/svg/file-icon.svg"/>{{ item.fileName }}</div>
                                <componentsTable :defaultAttribute="state.checkList.defaultAttribute"
                                    :data="item.records" :header="state.checkList.header"
                                    @cellClick="cellClick" @custom-click="customClick"
                    ...
                    <documentsDetailsPortion>
                        <template #title>
                            <div class="ap-cont-box-title-label">归档水印验证</div>
                        </template>
                        <template #content>
                            <div v-for="(item, index) in state.checkList.filesArchive">
                                <div class="files-name"><img src="../../../../assets/svg/file-icon.svg"/>{{ item.fileName }}</div>
                                <componentsTable :defaultAttribute="state.checkList.defaultAttribute"
                                    :data="item.records" :header="state.checkList.header"
                                    @cellClick="cellClick" @custom-click="customClick"
